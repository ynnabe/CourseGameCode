...
#include "CourseGameCodePawn.generated.h"

UCLASS()
class COURSEGAMECODE_API ACourseGameCodePawn : public APawn
{
	GENERATED_BODY()
...
public:
	...
	float GetInputForwrd() {return InputForward;}
...
private:
	...
	TWeakObjectPtr<AActor> CurrentViewActor;
};
