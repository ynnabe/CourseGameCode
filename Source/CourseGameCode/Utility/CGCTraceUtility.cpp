#include "CGCTraceUtility.h"

#include "DrawDebugHelpers.h"

bool CGCTraceUtility::SweepCapsuleSingleByChanel(const UWorld* World, FHitResult& OutHit, const FVector& Start,
                                                 const FVector& End, const FQuat& Rot, float CapsuleRadius, float CapsuleHalfHeight, ECollisionChannel TraceChanel,
                                                 const FCollisionQueryParams& QueryParams, const FCollisionResponseParams& ResponseParams, bool bDrawDebug,
...
bool CGCTraceUtility::SweepSphereSingleByChanel(const UWorld* World, FHitResult& OutHit, const FVector& Start,
	const FVector& End, float Radius, ECollisionChannel TraceChanel, const FCollisionQueryParams& QueryParams,
...
bool CGCTraceUtility::OverlapCapsuleAnyByProfile(const UWorld* World, const FVector Pos, float CapsuleRadius,
...
bool CGCTraceUtility::OverlapCapsuleBlockingByProfile(const UWorld* World, const FVector Pos, float CapsuleRadius,
	float CapsuleHalfHeight, FQuat Rotation, FName ProfileName, const FCollisionQueryParams& QueryParams,
	bool bDrawDebug, float DrawTime, FColor HitColor)
{
	bool bResult;
