...
#include "CGCGameInstance.generated.h"


DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnMathFound, bool, bIsFound);

UCLASS()
class COURSEGAMECODE_API UCGCGameInstance : public UGameInstance
{
	GENERATED_BODY()
public:
	...
	FOnMathFound OnMatchFoundDelegate;
...
protected:
	...
	UPROPERTY(Replicated, EditAnywhere, BlueprintReadOnly, Category="Server settings")
	FName ServerName;
...
private:
	...
	void DisplayNetworkErrorMessages(FString ErrorMessage);
};
